...
def save_result(train_times,test_r2_score ,client_number ,client_rate ,client_epoch , r ,non_idd ,attack):
    import logging
    ...
    log_context = log_times + log_context + log_parameters + log_idd_mode + log_attack_mode
