...
class MobileNet2(nn.Module):
    ...
    def __init__(self,input_size, num_classes, scale=1.0, t=6, in_channels=3, activation=nn.ReLU6):
        """
...
if __name__ == "__main__":
    ...
    input_size = 512
    num_classes = 6 
    model = MobileNet2(input_size, num_classes)
    y = torch.randn(10, 3, input_size, input_size)
    # print(model(y))
    print(y.size())